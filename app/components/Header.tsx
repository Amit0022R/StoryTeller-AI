    ...
    return (
        <header className="relative p-16 text-center" >
            ...
            <h1 className="text-6xl font-black" >StoryTeller-AI</h1>
                <div className="flex justify-center whitespac-nowrap space-x-5 text-3xl lg:text-5xl" >
            ...
            <Link href='/' >
                <FilePen
                    className="w-8 lg:w-10 lg:h-10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2 rounded-md hover:opacity-50 cursor-pointer" 
                />
            </Link>
            <Link href='/stories' >
            <BookOpen 
